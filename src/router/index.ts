 ...
 * @LastEditTime: 2022-04-12 22:36:00
 * @LastEditors: TYW
 * @Description:
 */
...
const routes: Array<RouteRecordRaw> = [
  ...
  },
  {
    path: '/Lesson010',
    name: 'Lesson010',
    component: () => import('../views/webgpu/Lesson010/views/Lesson010.vue')
  },
  {
    path: '/Lesson011',
    name: 'Lesson011',
    component: () => import('../views/webgpu/Lesson011/views/Lesson011.vue')
  }
];
